-- B0.1 flat-rate shift representation fix (proven in staging, commit b46f573438b66996a150994f579d49d3572392e6)
-- Only change vs. current production function: flat-rate shifts now store
-- total_hours = NULL instead of 0. Compensation is represented solely by
-- flat_rate_amount. All validation, authorization, 7-day window, allocation,
-- hourly-path, and admin-edit behavior is preserved verbatim.
