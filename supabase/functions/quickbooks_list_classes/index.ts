...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const query = encodeURIComponent("SELECT Id, Name, FullyQualifiedName, Active FROM Class WHERE Active = true MAXRESULTS 1000");
    ...
    const rawClasses = responseData?.QueryResponse?.Class || [];
